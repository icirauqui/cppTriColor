...
int main()
{
    ...
    roii.push_back(Point(0,100));
    roii.push_back(Point(100,100));
    roii.push_back(Point(100,200));
    roii.push_back(Point(0,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(100,100));
    roii.push_back(Point(200,100));
    roii.push_back(Point(200,200));
    roii.push_back(Point(100,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(200,100));
    roii.push_back(Point(300,100));
    roii.push_back(Point(300,200));
    roii.push_back(Point(200,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(300,100));
    roii.push_back(Point(400,100));
    roii.push_back(Point(400,200));
    roii.push_back(Point(300,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(400,100));
    roii.push_back(Point(500,100));
    roii.push_back(Point(500,200));
    roii.push_back(Point(400,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(500,100));
    roii.push_back(Point(600,100));
    roii.push_back(Point(600,200));
    roii.push_back(Point(500,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(600,100));
    roii.push_back(Point(700,100));
    roii.push_back(Point(700,200));
    roii.push_back(Point(600,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(700,100));
    roii.push_back(Point(800,100));
    roii.push_back(Point(800,200));
    roii.push_back(Point(700,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(800,100));
    roii.push_back(Point(900,100));
    roii.push_back(Point(900,200));
    roii.push_back(Point(800,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(900,100));
    roii.push_back(Point(1000,100));
    roii.push_back(Point(1000,200));
    roii.push_back(Point(900,200));
    roi.push_back(roii);
    roii.clear();
    roii.push_back(Point(1000,100));
    roii.push_back(Point(1100,100));
    roii.push_back(Point(1100,200));
    roii.push_back(Point(1000,200));
    roi.push_back(roii);
    roii.clear();
